...
@interface CustomTxt () <UITextFieldDelegate>

//筛选条件
@property (nonatomic,copy) NSString *filter;

@end
@implementation CustomTxt
...
-(void)initialize{
    ...
    self.leftPadding = 10;
    self.limitedType = LimitedTextFieldTypeNomal;
...
-(void)setLimitedType:(LimitedTextFieldType)limitedType{
